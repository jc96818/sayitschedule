...
| E2E - Generate Schedule | E2E | ⬜ Todo | `e2e/schedules.spec.ts` |
| E2E - View Schedule | E2E | ⬜ Todo | `e2e/schedules.spec.ts` |
| E2E - Edit Session | E2E | ⬜ Todo | `e2e/schedules.spec.ts` |
| E2E - Publish Schedule | E2E | ⬜ Todo | `e2e/schedules.spec.ts` |
