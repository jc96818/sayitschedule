...
- **Logo**: Displayed in the app header.
...
6. Optionally, enter a **Logo URL**:
   - The logo should be hosted on a publicly accessible URL.
   - Recommended size: 80x80 pixels.
   - Supported formats: PNG, JPG, SVG.
7. Preview your logo in the preview area below the input.
...
- **Printed schedules**: The organization name appears on printed schedule headers.
...
- **Logo not appearing**: Ensure the URL is publicly accessible (not behind a login). Try opening the URL directly in a browser to verify it works.
