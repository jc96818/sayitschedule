...
function handleGenerateSchedule(_weekStart: string) {
  router.push('/app/schedule/generate')
}
  ...
  <div>
    ...
    <div class="page-content">
      ...
      <Alert v-if="stats.conflicts > 0" variant="warning" class="mt-3">
        ...
        <RouterLink to="/app/schedule" style="margin-left: 8px;">Review now</RouterLink>
      </Alert>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div v-else-if="!currentWeekSchedule" class="text-center">
              ...
              <RouterLink to="/app/schedule/generate" class="btn btn-primary btn-sm">
                Generate Schedule
              </RouterLink>
            </div>
            <div v-else>
          ...
          <div class="card-footer">
            <RouterLink to="/app/schedule">View Full Schedule</RouterLink>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="quick-actions">
              <RouterLink to="/app/schedule/generate" class="btn btn-outline quick-action-btn">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="18" height="18">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                Generate New Schedule
              </RouterLink>
              <RouterLink to="/app/rules" class="btn btn-outline quick-action-btn">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="18" height="18">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                </svg>
                Add Voice Rule
              </RouterLink>
              <RouterLink to="/app/staff" class="btn btn-outline quick-action-btn">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="18" height="18">
